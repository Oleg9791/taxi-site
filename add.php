...
//    echo "<button style='margin: 100px 0px 0px 680px; height: 40px; background-color: green; text-align: center;' ><a style='text-decoration: none; color: aliceblue'  href='index.php' class='btn btn-success'>Пройти регистрацию заново</a></button>";
